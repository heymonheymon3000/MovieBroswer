 ...
 */
const val BOTTOM_NAV_BACKSTACK_KEY = "com.example.bestpractcies.openapi.util.BottomNavController.bottom_nav_backstack"
    ...
    fun onBackPressed() {
        ...
        when {
            ...
            navigationBackStack.size > 1 -> {
                Timber.d("logInfo: BNC: backstack size > 1")
            ...
            navigationBackStack.last() != appStartDestinationId -> {
                Timber.d("logInfo: BNC: start != current")
                navigationBackStack.removeLast()
